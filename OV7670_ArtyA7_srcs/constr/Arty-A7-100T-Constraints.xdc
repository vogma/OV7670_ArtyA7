...
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { ov7670_data[0] }]; #IO_L4P_T0_15 Sch=ja[2]
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { ov7670_data[2] }]; #IO_L4N_T0_15 Sch=ja[3]
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { ov7670_data[4] }]; #IO_L6P_T0_15 Sch=ja[4]
set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS33 } [get_ports { ov7670_reset }]; #IO_L6N_T0_VREF_15 Sch=ja[7]
set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { ov7670_data[1] }]; #IO_L10P_T1_AD11P_15 Sch=ja[8]
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { ov7670_data[3] }]; #IO_L10N_T1_AD11N_15 Sch=ja[9]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { ov7670_data[5] }]; #IO_25_15 Sch=ja[10]

## Pmod Header JB
set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVCMOS33} [get_ports ov7670_xclk]
#set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { ov7670_xclk }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
set_property -dict {PACKAGE_PIN D15 IOSTANDARD LVCMOS33} [get_ports ov7670_pclk]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { ov7670_vsync }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2]
set_property -dict {PACKAGE_PIN J17 IOSTANDARD LVCMOS33} [get_ports ov7670_href]
#set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { ov7670_sioc }]; #IO_L23N_T3_FWE_B_15 Sch=jb_n[3]
set_property -dict {PACKAGE_PIN K15 IOSTANDARD LVCMOS33} [get_ports ov7670_vsync]
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { ov7670_reset }]; #IO_L24N_T3_

set_property SLEW FAST [get_ports ov7670_xclk]

# ## Pmod Header JC
# set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {sseg_o[0]}]
# set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports {sseg_o[1]}]
# set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports {sseg_o[2]}]
# set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports {sseg_o[3]}]
...
# ## Pmod Header JD
# set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33} [get_ports {sseg_o[4]}]
# set_property -dict {PACKAGE_PIN D3 IOSTANDARD LVCMOS33} [get_ports {sseg_o[5]}]
# set_property -dict {PACKAGE_PIN F4 IOSTANDARD LVCMOS33} [get_ports {sseg_o[6]}]
# set_property -dict {PACKAGE_PIN F3 IOSTANDARD LVCMOS33} [get_ports sseg_cs_o]
...
##DO NOT USE -- From digilent vga demo
# #Pmod Header JB
